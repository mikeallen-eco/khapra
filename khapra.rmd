...
khapra_PCR$mean$p.PCRrep.low # 0.9633884
khapra_PCR$q2.5$p.PCRrep.low # 0.8308523
khapra_PCR$q97.5$p.PCRrep.low # 0.9995303

# what is the certainty of detecting 1 beetle at 3 technical replicates
khapra_PCR$mean$p.PCRrep.low # 0.8392480
khapra_PCR$q2.5$p.PCRrep.low # 0.5887243
khapra_PCR$q97.5$p.PCRrep.low # 0.9783276

# get non-standardized betas
khapra_PCR$mean$alpha0 # 4.422
khapra_PCR$mean$beta.dens # 1.858
...
ggsave("figures/Fig_khapra_detection_combined_400dpiB.png", 
